...
const MyDonations = () => {
    ...
    // console.log(user);
    useEffect(() => {
        fetch(`${import.meta.env.VITE_API_URL}/myDonations/${user?.email}`)
            .then((res) => res.json())
            .then((data) => {
                setItem(data);
            });
                        ...
                        <div className="card bg-base-100 shadow-xl">
                            ...
                            <div className="">
                                ...
                                <div className="card-actions justify-between">
                                    <Link to={`/donations/${p._id}`}><button className="btn btn-primary">Update</button></Link>
